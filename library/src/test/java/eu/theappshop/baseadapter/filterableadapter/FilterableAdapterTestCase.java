...
import eu.theappshop.baseadapter.adapterv2.ListUtils;
...
public class FilterableAdapterTestCase {
  ...
  public void setUp() {
    ...
    vm9 = new StubVM(9);
    vm10 = new StubVM(10);
    adapter = spy(new FilterableVmAdapter<>(new TestPredicate(), generateVmsList()));
  ...
  public void testGet() {
    ...
    assertThrows(IndexOutOfBoundsException.class, new TestUtils.Block() {
      @Override public void run() {
        adapter.get(eu.theappshop.baseadapter.adapterv2.ListUtils.filter(generateVmsList(),
            new TestPredicate()).size());
      }
    });
    StubVM vm = adapter.get(
        adapter.indexOf(eu.theappshop.baseadapter.adapterv2.ListUtils.filter(generateVmsList(),
  ...
  public void testInitialFilter() {
    assertEquals(eu.theappshop.baseadapter.adapterv2.ListUtils.filter(generateVmsList(),
  ...
  public void testGetSize() {
    assertEquals(
        eu.theappshop.baseadapter.adapterv2.ListUtils.filter(generateVmsList(), new TestPredicate())
